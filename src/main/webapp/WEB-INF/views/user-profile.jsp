						...
						<div class="media align-items-end profile-head">
							<div class="profile mr-3">
								<img
									...
									href="edit-profile" class="btn btn-primary" style= margin-left:35px;>Edit
									profile</a>
							</div>
							<div class="media-body mb-5 text-white">
								 <h3 class="mt-0 mb-0" class="name">${profile.first_name} ${profile.last_name}</h3>
					...
					<div class="px-4 py-3">
						...
						<div class="p-4 rounded shadow-sm bg-light">
							<p class="font-italic mb-0">Web Developer</p>
							 <p class="font-italic mb-0">${profile.country}, ${profile.city}</p>
